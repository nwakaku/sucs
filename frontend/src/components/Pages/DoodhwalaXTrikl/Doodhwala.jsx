      ...
      <div className="col-span-8 col-start-3 flex justify-between py-3">
        <h1 className="font-poppins font-semibold text-gray text-xl md:text-3xl text-center md:text-left w-full">
          <a
            href="https://sucs.xyz/"
            target="_blank"
            className="font-poppins font-semibold text-sucsBlue"
          >
            sucs
          </a>
    ...
    <div className="pt-28 flex flex-col justify-center items-center">
      ...
      <section className="text-center">
        <h2 className="text-base md:text-xl w-full text-black font-bold pb-4">
          ...
          <span className="text-sucsBlue">sucs</span>{" "}
          <span className="font-light">presents</span>
        </h2>
        <h2 className="text-4xl md:text-6xl w-full text-sucsBlue font-bold">
          Read & Earn Crypto
        </h2>
        <div className="w-full md:w-2/3 mx-auto pt-10">
          ...
          <span className="font-semibold"> sucs</span> you get rewarded for
...
const HowItWorks = () => {
  return (
    <div className="text-center">
      <h2 className="text-xl pt-10 pb-5 text-sucsBlue">How It Works?</h2>
    ...
    <div className="text-black flex-col justify-center text-center">
      <ul className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-10 md:pt-5 md:pb-5">
        <li className="text-black">
          <a href="https://twitter.com/sucsHQ" target="_blank" rel="noreferrer">
            <TwitterIcon fontSize="large" />
          </a>
        </li>
        <div className="flex gap-10">
          <li className="hover:text-sucsBlue">
            <a
              href="https://twitter.com/sucsHQ"
              target="_blank"
              rel="noreferrer"
            >
              @sucsHQ
      ...
      <p className="/70 pt-5 px-5 md:px-0">
        ...
        <a className="text-sucsBlue" href="mailto:contact@sucs.xyz">
          contact@sucs.xyz
        </a>
      </p>
    </div>
