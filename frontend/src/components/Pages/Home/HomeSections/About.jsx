  ...
  const cardData = [
    {
      id: 1,
      img: ProfileIcon,
      imgAlt: "Create Profile Image on sucs",
      heading: "Create Profile",
      description:
        "Connect your Metamask wallet to create your profile on blockchain. With sucs, Only YOU fully control your account.",
    },
    {
      id: 2,
      img: ShareLink,
      imgAlt: "Share Link Image on sucs",
      heading: "Share Link",
      description:
    ...
    },
    {
      id: 3,
      img: Community,
      imgAlt: "Community Support Image on sucs",
