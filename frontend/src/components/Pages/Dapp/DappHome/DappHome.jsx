...
const DappHome = () => {
  ...
  return (
    ...
    bg-sucsOffWhite bg-fixed relative"
    >
      {/* MOBILE */}
      {/* <div className="md:hidden absolute w-full h-full z-[100] flex justify-center text-lg text-textColor bg-sucsGray backdrop-blur-md text-left">
        <div className="w-2/3 pt-10">
          Please Try Again With A Desktop Device! <br /> <br /> sucs dApp is
          currently{" "}
