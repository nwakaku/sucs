...
const CreateProfileForm = () => {
  ...
  const inputs = [
    ...
    },
    {
      ...
      type: "text",
      TagType: "input",
      placeholder: "For your page - sucs.xyz/dapp/<username>",
      errorMessage:
    ...
    },
    {
      ...
      errorMessage: "Your Metamask wallet must be connected with sucs website",
      ...
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-8 flex flex-col gap-8 py-10">
          ...
          <div className="-mt-5 pt-0 text-gray-400 text-sm font-light">
            sucs's model is simple - we receive 2.5% of this membership fee.
            That's it!
          </div>
