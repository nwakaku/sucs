  ...
  return isAuthenticated && isCreator ? (
    <div>
      ...
      <div className="flex flex-col gap-5 justify-center pt-20">
        <div className="text-left mx-20 py-5 flex items-center justify-between border-b-2 border-sucsGray/20">
          ...
          <div className="flex gap-4 items-center">
            ...
            <button
              onClick={handleClick}
              className="bg-lightBlue hover:bg-sucsBlue hover:text-white w-max rounded-md px-5 py-1 text-base transition-all duration-300 ease-in-out"
            >
              Publish
            </button>
          </div>
  ...
  return (
    <div className="flex items-center gap-2">
      <input
        ...
        className="bg-sucsGray/20 border-sucsGray text-sucsBlue focus:ring-transparent rounded-md p-2"
      />
      <span
        className={`text-base ${isPaid ? "text-sucsBlue" : "text-sucsGray"} `}
      >
        Paid Post
      </span>
    </div>
